...
// Phase 5 stubs
func (m *phase2dMock) GetAgentIdentitiesByUserID(agentUserID string) ([]*api.AgentIdentity, error) {
	return nil, nil
}
func (m *phase2dMock) LookupIdentity(agentID, channelType, externalID string) (*api.AgentIdentity, *api.AgentUser, error) {
	return nil, nil, nil
}
func (m *phase2dMock) MergeAgentUsers(agentID, sourceUserID, targetUserID string) error { return nil }
func (m *phase2dMock) GetPendingActionByUserAndType(agentUserID, actionType string) (*api.AgentPendingAction, error) {
	return nil, nil
}
...
// Phase 6 stubs
func (m *phase2dMock) GetAgentUserByEmail(agentID, email string) (*api.AgentUser, error) {
	return nil, nil
}
func (m *phase2dMock) GetAgentUsersByAgentID(agentID string, limit, offset int) ([]*api.AgentUser, error) {
	return nil, nil
}
...
func (m *phase2dMock) DeleteMemoriesOlderThan(agentID string, olderThan time.Time, excludePinned bool) (int64, error) {
	return 0, nil
}
func (m *phase2dMock) DeleteExpiredMemories(limit int) (int64, error) { return 0, nil }
func (m *phase2dMock) GetAgentsWithRetentionPolicy() ([]struct {
	ID                  string `db:"id"`
...
func (m *phase2dMock) GetAuditLogForAgent(agentID string, limit, offset int) ([]*api.AgentAuditLog, error) {
	return nil, nil
}
func (m *phase2dMock) GetAuditLogForUser(agentUserID string, limit, offset int) ([]*api.AgentAuditLog, error) {
	return nil, nil
}
func (m *phase2dMock) UnlinkAgentIdentity(identityID string) error { return nil }
func (m *phase2dMock) GetAllDataForUser(agentUserID string) (*api.AgentDataExport, error) {
	return nil, nil
}

// Phase 7 stubs
func (m *phase2dMock) FindContradictionCandidates(agentUserID, memoryType string, embedding pgvector.Vector, threshold float64, limit int) ([]*api.AgentMemory, error) {
	return nil, nil
}
func (m *phase2dMock) FindNearDuplicates(agentUserID, memoryType string, embedding pgvector.Vector, threshold float64, excludeID string, limit int) ([]*api.AgentMemory, error) {
	return nil, nil
}
...
func (m *phase2dMock) UnpinOldestMemories(agentUserID string, count int) ([]string, error) {
	return nil, nil
}
