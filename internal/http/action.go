...
var subCategoryMetadata = map[string]struct {
	...
	"marketing/google_ads":           {Name: "Google Ads", Icon: "googleads", Description: "Build, adjust and report on Google advertising via the Google Ads API"},
...
var subSubCategoryMetadata = map[string]struct {
	...
	"marketing/google_ads/accounts":  {Name: "Accounts", Icon: "googleads", Description: "Ad accounts reachable by the connected Google Ads login, and the manager hierarchy above them"},
	"marketing/google_ads/campaigns": {Name: "Campaigns", Icon: "googleads", Description: "Campaign budgets, bidding, channel type and state"},
	"marketing/google_ads/adgroups":  {Name: "Ad Groups", Icon: "googleads", Description: "Ad groups, their bids and their state"},
	"marketing/google_ads/ads":       {Name: "Ads", Icon: "googleads", Description: "Individual ads, their headlines and descriptions, and their state"},
	"marketing/google_ads/keywords":  {Name: "Keywords", Icon: "googleads", Description: "Keywords, negative keywords and the search terms they actually matched"},
	"marketing/google_ads/reporting": {Name: "Reporting", Icon: "googleads", Description: "Performance reporting at any level, plus raw GAQL and the field catalogue"},
