...
var salesforcePickerGroups = []salesforcePickerGroup{
	...
	{"filter_field", "salesforce-fields?filter=all&object=Account", nil, []string{"account_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Attachment", nil, []string{"attachment_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Campaign", nil, []string{"campaign_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Case", nil, []string{"case_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Contact", nil, []string{"contact_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Event", nil, []string{"event_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Lead", nil, []string{"lead_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Opportunity", nil, []string{"opportunity_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=Task", nil, []string{"task_get_all"}},
	{"filter_field", "salesforce-fields?filter=all&object=User", nil, []string{"user_get_all"}},
	{"filter_field", "salesforce-fields?filter=all", []string{"custom_object"}, []string{"custom_object_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Account", nil, []string{"account_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=AccountContactRelation", nil, []string{"account_contact_relation_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Attachment", nil, []string{"attachment_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Campaign", nil, []string{"campaign_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=CampaignMember", nil, []string{"campaign_member_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Case", nil, []string{"case_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=CaseComment", nil, []string{"case_comment_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Contact", nil, []string{"contact_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=EmailMessage", nil, []string{"email_message_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Event", nil, []string{"event_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Lead", nil, []string{"lead_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Opportunity", nil, []string{"opportunity_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=OpportunityContactRole", nil, []string{"opportunity_contact_role_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=OpportunityLineItem", nil, []string{"opportunity_line_item_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=Task", nil, []string{"task_get_all"}},
	{"order_by", "salesforce-fields?filter=all&object=User", nil, []string{"user_get_all"}},
	{"order_by", "salesforce-fields?filter=all", []string{"custom_object"}, []string{"custom_object_get_all"}},
	{"order_by", "salesforce-fields?filter=all", []string{"object"}, []string{"record_find"}},
	...
	{"match_field", "salesforce-fields?filter=all", []string{"object"}, []string{"record_find"}},
	...
	{"converted_status", "salesforce-picklist?object=Lead&field=Status", nil, []string{"lead_convert"}},
	...
	{"owner_id", "salesforce-users", nil, []string{"account_add_note", "attachment_create", "attachment_update", "contact_add_note", "event_create", "event_get_all", "event_update", "file_upload", "lead_add_note", "lead_convert", "opportunity_add_note"}},
