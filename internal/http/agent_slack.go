...
var requiredSlackScopes = []struct {
	...
	{"search:read.public", "Search public channel messages", "slack_search"},
	{"search:read.private", "Search private channel messages", "slack_search"},
	{"search:read.im", "Search direct messages", "slack_search"},
	{"search:read.mpim", "Search group DMs", "slack_search"},
	{"search:read.files", "Search files", "slack_search"},
