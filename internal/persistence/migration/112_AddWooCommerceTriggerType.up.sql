-- Seed the trigger_type row for the WooCommerce webhook trigger. Without it,
...
INSERT INTO trigger_type (name) VALUES ('woocommerce-webhook') ON CONFLICT DO NOTHING;
